        ...
        <table class="table">
            ...
            @foreach($courrier as $courriers)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('courriers_bo.show', $courriers->id)}}" class="btn btn-primary btn-sm">Show</a>
                        <a href="{{ route('courriers_bo.edit', $courriers->id)}}" class="btn btn-primary btn-sm">Edit</a>
                    </td>
                </tr>
            @endforeach
            </tbody>
