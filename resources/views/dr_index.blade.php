        ...
        <table class="table">
            ...
            @foreach($courrier as $courriers)
                <tr>
                    ...
                    <td>
                        <a href="{{ route('courriers_dr.show', $courriers->id)}}" class="btn btn-primary btn-sm">Show</a>
                        <a href="{{ route('courriers_dr.edit', $courriers->id)}}" class="btn btn-primary btn-sm">Edit</a>
                    </td>
                </tr>
            @endforeach
            </tbody>
